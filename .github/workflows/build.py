...
# Try reading Sheet2 first (new format), fall back to first sheet
try:
    df_s = pd.read_excel(FILE_SUPORTES, sheet_name="Sheet2")
    if df_s.shape[1] < 4:
        raise ValueError("Sheet2 does not have 4 columns")
except:
